        ...
        <div class="pet-content-section">
            <div class="pet-card">
                <div class="pet-img-frame">
                    <img src="{{asset('assets/images/svgs/avatar1.svg')}}" alt="avatar1" class="pet-img">
                </div>
            ...
            <div class="pet-card">
                <div class="pet-img-frame">
                    <img src="{{asset('assets/images/svgs/avatar1.svg')}}" alt="avatar2" class="pet-img">
                </div>
                <div class="pet-text-content">
                    <h4>Avatar 2</h4>
                    <p>Ang pinakamahusay na paglalakbay puno ng matematika sa puso ng Pilipinas!</p>
            ...
            <div class="pet-card">
                <div class="pet-img-frame">
                    <img src="{{asset('assets/images/svgs/avatar1.svg')}}" alt="avatar3" class="pet-img">
                </div>
                <div class="pet-text-content">
                    <h4>Avatar 3</h4>
                    <p>Ang pinakamahusay na paglalakbay puno ng matematika sa puso ng Pilipinas!</p>
